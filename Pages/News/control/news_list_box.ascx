    ...
    <ContentTemplate>
        <div class="WorkingBox" >
            <asp:GridView ID="gridview_news_list" runat="server" CellPadding="5" Width="100%"
                ...
                OnPageIndexChanging="gridview_news_list_PageIndexChanging" PageSize="5" 
                OnRowCommand="gridview_news_list_RowCommand" ShowFooter="True" >
                <Columns>
                    <asp:TemplateField>
                        <HeaderTemplate>
                         <asp:LinkButton runat="server" ID="lbtn_more_stories" PostBackUrl='<%#GenerateNewTypeinkOnly() %>' Text='<%#Header %>'  SkinID="menu"  >
                         </asp:LinkButton>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <table border="0" width="100%">
                                <tr valign="top">
                                    ...
                                    <td valign="top" style="width: 100%">
                                        <a href='<%#GenerateNewDetailPageLinkOnly((String)Eval("news_id")) %>' class="label_list_item" target="_self">
                                            <%# Eval("subject")%></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label runat="server" ID="lbl_source" Text='<%#String.Format("Source: {0}",(String)Eval("source_name")) %>' CssClass="label_supporter"/>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <table width="100%">
                        <tr>
                        <td align="right"> <asp:LinkButton runat="server" ID="lbtn_more_stories" Text="More Stories" PostBackUrl='<%#GenerateNewTypeinkOnly() %>' /></td>
                        </tr>
                        </table>
